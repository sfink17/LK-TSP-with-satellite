...
interface PointIF {
    var nearestK: MutableList<Pair<Int, Double>>
    val index: Int
}

class Point(val coords: Pair<Double, Double>, override val index: Int) : PointIF{
    override var nearestK: MutableList<Pair<Int, Double>> = mutableListOf()
...
var edgeCache: HashMap<Long, Double> = HashMap()